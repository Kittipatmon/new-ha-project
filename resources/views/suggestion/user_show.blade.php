    ...
    <div class="container mx-auto px-4 py-8 max-w-8xl">
        ...
        <div class="flex items-center text-sm mb-4 space-x-2">
            ...
            <a href="{{ route('suggestion.index') }}"
                class="text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">รับเรื่องร้องเรียน</a>
            <i class="fas fa-chevron-right text-[10px] text-gray-500"></i>
            <span class="text-red-500 font-medium">รายละเอียดการร้องเรียน</span>
        </div>
    </div>

    <div class="container mx-auto px-4 py-0 max-w-4xl">
        <div class="flex items-center mb-6">
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-4">
                <a href="{{ route('suggestion.index') }}" class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors text-slate-700 dark:text-gray-300">
        ...
        <div
            ...
            <div class="absolute top-0 w-full h-2 bg-gradient-to-r from-blue-500 to-blue-600"></div>
            ...
            @endif
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 pb-6 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-user text-blue-500"></i> ข้อมูลผู้ร้องเรียน
                        </h3>
                        <div class="space-y-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-map-location-dot text-blue-500"></i> ที่อยู่
                        </h3>
                ...
                <div class="mb-8 pb-6 border-b border-gray-100 dark:border-gray-800 space-y-8">
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-file-lines text-blue-500"></i> รายละเอียดของปัญหาที่ได้รับ
                        </h3>
                        <div
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-bullseye text-blue-500"></i> ความต้องการของผู้ร้องเรียน
                        </h3>
                        <div
                            class="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-100 dark:border-gray-700">
                            <p class="text-gray-800 dark:text-gray-200 whitespace-pre-line text-base leading-relaxed">
                ...
                @if((is_array($suggestion->docs) && count($suggestion->docs) > 0) || $suggestion->other_docs_detail || (is_array($suggestion->attachments) && count($suggestion->attachments) > 0))
                    <div class="mb-4">
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-paperclip text-blue-500"></i> เอกสารหลักฐานประกอบ
                        </h3>
