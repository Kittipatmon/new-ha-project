...
<button type="button" id="openCreateModal" class="btn btn-success btn-sm text-white shadow-md w-full sm:w-auto flex items-center justify-center whitespace-nowrap px-4 mb-4">
    <i class="fa-solid fa-plus mr-2"></i> เพิ่มประเภทคำร้อง
</button>
                ...
                <table class="table w-full">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-2 text-left">ชื่อประเภทคำร้อง (TH)</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($categories as $index => $category)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                                ...
                                <!-- <td class="px-6 py-2 font-mono text-sm text-blue-600 dark:text-blue-400">{{ $category->code ?? '-' }}</td> -->
                                ...
                                <td class="px-6 py-2 text-center space-x-2">
                                    <button type="button" class="btn btn-warning btn-sm btn-square text-white editBtn shadow-sm"
                                        ...
                                        data-name_th="{{ $category->name_th }}" data-name_en="{{ $category->name_en }}"
                                        data-description="{{ $category->description }}"
                                        data-is_active="{{ $category->is_active }}" title="แก้ไข">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </button>
                                    <button type="button" class="btn btn-error btn-sm btn-square text-white deleteBtn shadow-sm"
                                        data-id="{{ $category->id }}" data-name="{{ $category->name_th }}" title="ลบ">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg transform transition-all scale-100">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100">
                    <i class="fa-solid fa-plus-circle mr-2 text-green-500"></i>เพิ่มประเภทคำร้อง
                </h2>
            ...
            <form method="POST" action="{{ route('request-categories.store') }}" class="px-6 mb-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">รหัส <span
                                class="text-red-500">*</span></label>
                        <input name="code" type="text" class="input input-bordered w-full dark:text-black"
                            placeholder="เช่น REQ-01" required />
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ชื่อ (TH) <span
                                class="text-red-500">*</span></label>
                        <input name="name_th" type="text" class="input input-bordered w-full dark:text-black" required />
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100"><i
                        class="fa-solid fa-edit mr-2 text-yellow-500"></i>แก้ไขประเภทคำร้อง</h2>
            ...
            <form method="POST" id="editForm" class="px-6 mb-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="code" id="edit_code" type="text" class="input input-bordered w-full dark:text-black"
                            required />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">สถานะ</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ชื่อ (TH) <span
                            class="text-red-500">*</span></label>
                    <input name="name_th" id="edit_name_th" type="text" class="input input-bordered w-full dark:text-black"
                        required />
                </div>
                <!-- <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ชื่อ (EN)</label>
