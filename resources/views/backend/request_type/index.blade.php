...
<button type="button" id="openCreateModal" class="btn btn-success btn-sm text-white shadow-md w-full sm:w-auto flex items-center justify-center whitespace-nowrap px-4">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                                ...
                                <td class="px-6 py-2 text-center space-x-2">
                                    ...
                                    <button type="button" class="btn btn-error btn-sm btn-square text-white deleteBtn shadow-sm"
                                        data-id="{{ $requesttype->id }}" data-name="{{ $requesttype->name_th }}" title="ลบ">
