            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <ul class="hidden lg:flex space-x-1 items-center">
                        ...
                        @auth
                            @php
                                $isApprover = Auth::user()->hr_status == 0 ||
                                    \App\Models\Recruitment\RecruitmentRequest::where('approver_manager_id', Auth::id())
                                        ->orWhere('approver_executive_id', Auth::id())
                                        ->exists();
                            @endphp
                            @if($isApprover)
                                <li>
                                    <a class="navbar-link shadow transition"
                                        href="{{ route('recruitment.reports') }}">รายงานคำขอ</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
