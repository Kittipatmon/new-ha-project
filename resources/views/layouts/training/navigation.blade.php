            ...
            <form method="POST" action="{{ route('login') }}" class="px-6 pb-6 pt-4 space-y-4">
                ...
                <div>
                    ...
                    <!-- <input id="employee_code" name="employee_code" type="text" autocomplete="username" required
                                                                                   s="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500" value="{{ old('employee_code') }}"> -->
                    @error('employee_code')
