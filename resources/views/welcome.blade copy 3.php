            ...
            <div czlass="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20">
                    ...
                    <div class="text-center lg:text-left order-2 lg:order-1">
                        <div
                            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-500/20 mb-6">
                            <span class="relative flex h-2 w-2">
                                <span
                                    class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                            </span>
                            <span class="text-red-600 dark:text-red-400 text-xs font-semibold tracking-wide uppercase">HR
                                Platform 2.0</span>
                        </div>

                        <h1
                            class="text-4xl lg:text-6xl font-bold mb-6 leading-[1.15] tracking-tight text-slate-900 dark:text-white">
                            Welcome to <br>
                            <span class="text-gradient-red">Human Assetment</span>
                        </h1>

                        <p
                            class="text-slate-600 dark:text-slate-400 text-base lg:text-lg max-w-2xl mb-10 font-light leading-relaxed mx-auto lg:mx-0">
                        ...
                        <div class="flex flex-wrap justify-center lg:justify-start gap-4">
                            <a href="#"
                                class="group px-7 py-3 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-red-600/30 hover:shadow-red-600/40 transition-all flex items-center gap-2">
                                <span>นโยบายองค์กร</span>
                                <i class="fa-solid fa-arrow-right group-hover:translate-x-1 transition-transform"></i>
                            </a>
                            <a href="#"
                                class="px-7 py-3 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-red-500 dark:hover:border-red-500 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-white/10 transition-all">
                                พันธกิจ (Mission)
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="relative order-1 lg:order-2 lg:h-[500px] flex items-center justify-center">
                        <div
                            class="relative w-full aspect-square lg:aspect-auto lg:h-full rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/50 dark:shadow-black/50 animate-float border border-slate-100 dark:border-white/10">
                        ...
                        <div class="lg:col-span-5 flex flex-col gap-4 h-[500px] overflow-y-auto no-scrollbar pr-2">
                            @forelse($otherNews->take(4) as $item)
                                <a href="{{ route('news.detail', $item->news_id) }}"
                                    class="group flex gap-4 p-4 bg-white dark:bg-[#1E2129] rounded-2xl border border-slate-100 dark:border-white/5 hover:border-red-200 dark:hover:border-red-500/30 transition-all hover:shadow-lg dark:hover:shadow-none">
