    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden transition-all">
        ...
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="bg-amber-100 dark:bg-amber-500/20 p-2 rounded-lg text-amber-600 dark:text-amber-500">
                    <i class="fas fa-user-tie text-lg"></i>
                </div>
                <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">รายการรอดำเนินการ (ผู้จัดการ)</h2>
            </div>
            <span class="bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400 py-1 px-3 rounded-full text-xs font-bold">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('requesthr.detailMana', $request->hr_request_id ) }}" 
                               class="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-amber-500 border border-transparent rounded-lg shadow-sm hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all group-hover:shadow-md">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center space-y-3">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">เมื่อมีคำร้องส่งถึงผู้จัดการ ข้อมูลจะแสดงที่นี่</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
