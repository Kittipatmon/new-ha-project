...
<div class="w-full mx-auto px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex items-center space-x-2 text-sm text-gray-500 mb-6 font-medium">
        ...
        <span class="text-gray-400">&gt;</span>
        <span class="text-red-600">รายงานคำร้องขอ (อยู่ระหว่างรอดำเนินการ)</span>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden transition-all">
        ...
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="bg-blue-100 dark:bg-blue-500/20 p-2 rounded-lg text-blue-600 dark:text-blue-500">
                    <i class="fas fa-clock text-lg"></i>
                </div>
                <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">รายการรอดำเนินการ (อยู่ระหว่างการพิจารณา)</h2>
            </div>
            <span class="bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400 py-1 px-3 rounded-full text-xs font-bold">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center space-y-3">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">คุณยังไม่มีคำร้องที่อยู่ระหว่างการพิจารณาในขณะนี้</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
